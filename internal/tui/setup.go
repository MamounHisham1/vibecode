	...
	return []ProviderInfo{
		{
			...
			Models: []ModelInfo{
				...
				{ID: "claude-sonnet-4-5-20250514", Name: "Claude Sonnet 4.5", Description: "Previous generation, proven reliable"},
				{ID: "claude-opus-4-20250514", Name: "Claude Opus 4.0", Description: "Previous flagship model"},
			},
		},
		{
			ID:      "openai",
			...
			Models: []ModelInfo{
				...
				{ID: "gpt-4o", Name: "GPT-4o", Description: "Multimodal, fast and capable"},
				{ID: "gpt-4.1-mini", Name: "GPT-4.1 mini", Description: "Affordable and efficient"},
			},
		},
		{
			ID:      "deepseek",
			...
			Models: []ModelInfo{
				...
				{ID: "deepseek-reasoner", Name: "DeepSeek-R1", Description: "Advanced reasoning model"},
				{ID: "deepseek-coder", Name: "DeepSeek-Coder V2", Description: "Specialized for coding tasks"},
				{ID: "deepseek-v3-0324", Name: "DeepSeek-V3-0324", Description: "Updated V3 with improvements"},
				{ID: "deepseek-r1-0528", Name: "DeepSeek-R1-0528", Description: "Updated R1 reasoning model"},
			},
		},
		{
			ID:      "kimi",
			...
			Models: []ModelInfo{
				{ID: "kimi-latest", Name: "Kimi Latest", Description: "Most capable Kimi model"},
				{ID: "k2", Name: "Kimi K2", Description: "Next-generation model"},
				...
				{ID: "moonshot-v1-8k", Name: "Moonshot v1 8K", Description: "8K context, fast responses"},
			},
		},
		{
			ID:      "moonshot",
		...
		},
		{
			...
			Models: []ModelInfo{
				{ID: "glm-4-plus", Name: "GLM-4 Plus", Description: "Most capable GLM model"},
				{ID: "glm-4-air", Name: "GLM-4 Air", Description: "Balanced performance"},
				{ID: "glm-4-airx", Name: "GLM-4 AirX", Description: "Fast inference"},
				{ID: "glm-4-flash", Name: "GLM-4 Flash", Description: "Free tier, fast"},
				{ID: "glm-4-long", Name: "GLM-4 Long", Description: "128K context window"},
			},
		},
		{
			ID:      "qwen",
			...
			Models: []ModelInfo{
				...
				{ID: "qwen-turbo", Name: "Qwen Turbo", Description: "Fast and affordable"},
				{ID: "qwq-32b", Name: "QwQ-32B", Description: "Reasoning model"},
				{ID: "qwen-coder-plus", Name: "Qwen Coder Plus", Description: "Specialized for coding"},
			},
		},
		{
			ID:      "ollama",
